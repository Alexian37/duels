...
define({
    ...
    HERO_CARDS: [
        [
            ...
            { target: 0, strength: 1, init: 2, hit: MOVE_ONE, end_turn: EXACTLY_3_INIT_TOKEN },
            { target: 0, strength: 0, init: -1, before_action: FORWARD_0_TO_3_SPACES_LOSE_1_PER_SPACE },
